            ...
            <div className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex items-start gap-4 p-4 bg-[#0A0A0A] rounded-lg border border-[#111]">
                            ...
                            <div>
                                ...
                                <p className="text-white">registry@mit.edu</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 p-4 bg-[#0A0A0A] rounded-lg border border-[#111]">
                            <div className="p-2 bg-[#111] rounded-md">
                            ...
                            <div>
                                ...
                                <p className="text-white">October 12, 2023</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-6 rounded-xl border border-red-500/20 bg-[#0A0000] space-y-4">
                    ...
                    <p className="text-gray-400 text-sm max-w-xl">
                        Logging out will require you to sign in again to access the dashboard and issue any further credentials.
                    </p>
