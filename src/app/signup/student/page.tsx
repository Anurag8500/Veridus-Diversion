...
export default function StudentSignUp() {
    return (
        <AuthLayout
            ...
            description="Create your VERIDUS account to access and share your verified academic credentials."
        >
            ...
            <div className="mt-8 pt-6 border-t border-border-subtle flex flex-col gap-4 text-center">
                <p className="text-sm text-text-secondary">
                    ...
                    <Link href="/signin/student" className="text-text-primary hover:text-brand font-medium transition-colors">
                        Sign in
                    </Link>
                </p>
                <p className="text-sm text-text-tertiary">
                    Registering an institution?{" "}
                    <Link href="/signup/university" className="text-text-secondary hover:text-text-primary transition-colors underline underline-offset-4">
