...
export default function UnifiedSignUp() {
    ...
    const handleGoogleSignUp = async () => {
        ...
        setError("");
        try {
            await signIn("google", { callbackUrl: "/oauth-success" });
        } catch (err) {
    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-white text-black rounded-xl py-3 px-4 font-medium hover:bg-white/90 hover:scale-[1.01] active:scale-95 transition-all mb-6 shadow-[0_0_15px_rgba(255,255,255,0.05)] border border-border-base disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
                {googleLoading ? (
            ...
            <div className="relative flex items-center gap-4 mb-6">
                ...
                <span className="text-xs text-text-tertiary uppercase tracking-widest font-medium">Or email signup</span>
                <div className="flex-1 h-px bg-border-subtle"></div>
            </div>
